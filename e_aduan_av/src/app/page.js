    ...
    answer: (
      <div className="space-y-4">
        ...
        <ul className="list-disc ml-8 space-y-2 text-sm text-gray-600">
          <li>
            Ensure that all the following switches are in the <b>ON position</b>
            :
          </li>
          ...
          <li>
            Ensure the <b>HDMI cable </b>is securely connected to both the
            laptop and the control panel
          </li>
          ...
          <li>
            Press the <b>HDMI</b> button on the control panel
          </li>
          <Image
            src="/HDMIbutton.jpg"
            width={350}
          ...
          <p className="text-red-600 text-lg font-bold">
            If there is no display on the projector screen, please follow the
            steps below:{" "}
          </p>
          <li>
            Right-click on the desktop and select <b>'Display Settings'</b>,
            then choose <b>'Duplicate these displays'</b> under the Multiple
            Displays section
          </li>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 my-3">
            <Image
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-4">
        <ul className="list-disc ml-8 space-y-2 text-sm text-gray-600">
          <li>
            Please make sure that the <b>audiojack is connected</b> to the
            laptop
          </li>
          <li>
            Select the <b>'Sound Output'</b> and then choose the correct{" "}
            <b>'Output Device'</b>
          </li>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 my-3">
            <Image
    ...
    answer: (
      <div className="space-y-4">
        ...
        <ol className="list-decimal ml-8 mt-2 space-y-1 text-sm text-gray-700">
          <li>Click the <b>Laporkan Aduan (Rasmi)</b> button below.</li>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto px-5 py-2 bg-green-500 text-white rounded-full shadow hover:bg-green-600 transition text-center  gap-2"
          >
          ...
          <div className="lg:col-span-1 mt-10 lg:mt-18">
            <div className="bg-white p-6 rounded-2xl shadow-xl border-t-4 border-indigo-600">
              ...
              <p className="text-gray-600 mb-4 text-sm">
                Sila rujuk waktu operasi bilik teknikal di bawah untuk
                mendapatkan bantuan AV:
              </p>
              <div className="space-y-3">
                ...
                <div className="pt-2">
                  <a
                    href="/report"
                    className="flex items-center justify-center w-full px-5 py-3 bg-indigo-700 text-white font-bold rounded-xl shadow-lg hover:bg-indigo-800 hover:shadow-indigo-200 transition-all duration-300 gap-2"
                  >
